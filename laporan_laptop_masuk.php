...
<title>JUAL BELI LAPTOP JALDIN - Laporan Data Stok Laptop</title>
<style>
  body {
...
<h1 align="center">LAPORAN DATA STOK LAPTOP</h1>
...
<table>
  ...
  $no = 1;
  $query = mysqli_query($koneksidatabase, "SELECT * FROM datastok");
  ...
  <tr>
    ...
    <td>
      <a href="hapus_laptop.php?nama_laptop=<?php echo $data['nama_laptop']; ?>">Delete</a>
    </td>
  </tr>
  <?php
  }
